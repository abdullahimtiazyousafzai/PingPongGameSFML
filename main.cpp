...
int main()
{
    ...
    if (!winbuffer.loadFromFile("F:/CLionProjects/PingPongGameSFML/win.wav"))
        return -1;
    ...
    float ball_speed_x = 400.0f;
    float ball_speed_y = 400.0f;
    ...
    score_text_right.setPosition(650.f , 10.0f);
    ...
    while (window.isOpen())
    {
        ...
        // Move the ball
        ball.move(ball_speed_x * delta_time, ball_speed_y * delta_time);
